...
$dataform = DB::query('SELECT * FROM users WHERE id=:id', array(':id'=>isLoggedIn()))[0];


if (isset($_POST['createpost'])) {
    if ($dataform['username'] === $_POST['username']) {
        $alertsuccess++;
    } else {
        if (DB::query('SELECT username FROM users WHERE username=:username', array(':username'=>$_POST['username']))[0]['username'] != $_POST['username']) {
            DB::query('UPDATE users SET username=:username WHERE id=:id', array(':username'=>$_POST['username'], ':id'=>isLoggedIn()));
            $alertsuccess++;
        } else {
            $alerterror++;
            $alertusername_1 = 'Username already exists!';
        }
    }
    DB::query('UPDATE users SET fname=:username WHERE id=:id', array(':username'=>$_POST['fname'], ':id'=>isLoggedIn()));
    DB::query('UPDATE users SET lname=:username WHERE id=:id', array(':username'=>$_POST['lname'], ':id'=>isLoggedIn()));
    DB::query('UPDATE users SET discord=:username WHERE id=:id', array(':username'=>$_POST['discord'], ':id'=>isLoggedIn()));
    DB::query('UPDATE users SET facebook=:username WHERE id=:id', array(':username'=>$_POST['facebook'], ':id'=>isLoggedIn()));
}
...
?>
    ...
    <div class="container" style="margin-top: 50px;">
        ...
        <h1 style="display: inline-block !important; margin-top: 30px; margin-left: 15px; font-weight: 600;">gfdgfop[FGDDO</h1>
        <div class="row mt-3">
...
<form action="/my/?page=account" method="post">
    <?php
    if ($alertsuccess > 0) {
        ...
        Some fields have not been updated:<br>'.
        $alertusername_1.'
      </div>';
    }
...
<div class="row g-3 mb-3">
                <div class="col-sm-6">
                    ...
                    <input value="<?=$dataform['fname']?>" name="fname" type="text" class="form-control" id="exampleFormControlInput1" placeholder="John">
                </div>
                <div class="col-sm-6">
                    <label for="exampleFormControlInput1" class="form-label">Last Name</label>
                    <input value="<?=$dataform['lname']?>" name="lname" type="text" class="form-control" id="exampleFormControlInput1" placeholder="Magror">
                </div>
            </div>
                <div class="col-sm-12">
                    <label for="exampleFormControlInput1" class="form-label">Username</label>
                    <input value="<?=$dataform['username']?>" name="username" type="text" class="form-control" id="exampleFormControlInput1" placeholder="blablabla123">
                </div>

            <div class="row g-3 mt-1">
                <div class="col-sm-6">
                    <label for="exampleFormControlInput1" class="form-label">Old Password</label>
                    <input name="oldp" type="password" class="form-control" id="exampleFormControlInput1" placeholder="">
                </div>
                <div class="col-sm-6">
                    <label for="exampleFormControlInput1" class="form-label">New Password</label>
                    <input name="newp" type="password" class="form-control" id="exampleFormControlInput1" placeholder="">
                </div><br>
            </div>
            <div class="row g-3 mt-1">
                <div class="col-sm-6">
                    <label for="exampleFormControlInput1" class="form-label">Discord</label>
                    <input value="<?=$dataform['discord']?>" name="discord" type="text" class="form-control" id="exampleFormControlInput1" placeholder="blablabla#1234">
                </div>
                <div class="col-sm-6">
                    <label for="exampleFormControlInput1" class="form-label">Facebook</label>
                    <input value="<?=$dataform['facebook']?>" name="facebook" type="text" class="form-control" id="exampleFormControlInput1" placeholder="facebook.com/blablabla123">
                </div><br>
            </div>
            <button style="margin-top: 15px; " name="createpost" class="loginbtn">Update</button>

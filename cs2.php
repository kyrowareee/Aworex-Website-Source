...
<head>
<meta name="description" content="Aworex CS2 brings unparalleled performance to your Counter-Strike experience. Dive into the competitive edge with confidence, and don't miss out on our 3-hour free trial to witness the remarkable difference firsthand.">
<meta name="keywords" content="Buy Cheat for Cs2, CSGO Private Cheats, Private CSGO Cheats, CSGO Hacks for Free, Best CSGO Hacks, CSGO 2 Hacks, Cs2 Cheats, Cs2 Game Cheats">
...
.fancybox__container.has-slideshow .fancybox__button--slideshow g:nth-child(2) {
  ...
  <title>Buy CS2 Private Hacks | Aworex</title>
...
<body style="
background-image: url('/static/img/bckcsgo.png') !important;
...
?>
  ...
  <div class="row align-items-center g-5 py-5">
    ...
    <div class="col-lg-6">
        <?php
    if ((int)$data_tvt['csgo'] === 1) {
        $text = 'Undetected';
        $color = '#86FF0D'; 
    } else if ((int)$data_tvt['csgo'] === 2) {
        $text = 'Updating';
        $color = '#f4900c'; 
    } else {
        $text = 'Detected';
    ...
    ?>
        <p style="font-size: 17px;"><b style="color: <?=$color?>; font-weight: 400;">
            ...
            <circle cx="5" cy="5" r="5" fill="<?=$color?>"/> <?=$text?>
             ...
             <?=$text?></b></p>
      <h1 style="color: #fff !important; font-size: 75px;" class="fw-bold text-body-emphasis lh-1 mb-3"><img style="margin-right: 10px;" width="60" src="/static/img/cs2l.png">CS2</h1>
      <p style="font-size: 20px; color: #aca6a7; margin-top: 20px; margin-bottom: 20px;">Welcome to Aworex – Your Ultimate CS2 Companion!<br><br>

Aworex is CSGO Private Cheats designed to revolutionize your CS2 experience. Dive into the world of Counter-Strike with confidence, knowing that Aworex offers unparalleled enhancements. Our advanced features are backed by robust security measures, ensuring you can compete with peace of mind. Join our community and try out the best CSGO 2 hack.</p>
     
    </div>
    <div class="col-10 col-sm-8 col-lg-6">
        <video style="width: 100% !important; margin-top: 30px;" src="/static/cs2.mp4" class="d-block imgFullItem" controls="" autoplay="" muted=""></video>
    </div>
  </div>
  </div>
  <div class="container col-xxl-8">
   <center> <h2 style="color: #fff !important; font-size: 75px;" class="fw-bold text-body-emphasis lh-1 mb-3">Functions</h2></center>
  </div>
  <div class="container">
      ...
      <div class="col-lg-8 container">
        <div class="accordion" id="accordionExample">
            <div  style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
              ...
              <b>Aimbot</b> <i style="margin-left: 9px; color: #246bf4" class="bi bi-chevron-up"></i>
                </button>
              </h2>
              <div style="background-color: #020b1c;" id="collapseOne" class="accordion-collapse  show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                <div style="color: #afa6a8;" class="accordion-body">
                    Our legit and rage csgo aimbot lets you choose whether you want to subtly improve your game or utterly decimate your opponents. Better than any csgo aim training map, you will quickly become the envy of your friends.
            ...
            <div  style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
                ...
                <b>Recoil Control</b> <i style="margin-left: 9px; color: #246bf4" class="bi bi-chevron-up"></i>
                  </div>
                </h2>
                <div style="background-color: #020b1c;" id="collapseOnet" class="accordion-collapse  show" aria-labelledby="headingOnet" data-bs-parent="#accordionExample">
                  <div style="color: #afa6a8;" class="accordion-body">
                     Learn how to control your spray by watching our Recoil Control System move your mouse along the spray pattern. Your bullets will go exactly where you want them to every time.
                  </div>
                </div>
              </div>
              ...
              <div  style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
                ...
                <b>Wall Hacks</b> <i style="margin-left: 9px; color: #246bf4" class="bi bi-chevron-up"></i>
                  </div>
                </h2>
                <div style="background-color: #020b1c;" id="collapseOnettt" class="accordion-collapse  show" aria-labelledby="headingOnettt" data-bs-parent="#accordionExample">
                  <div style="color: #afa6a8;" class="accordion-body">
                      See everyone, everywhere with this csgo wallhack. Nobody will catch you off guard.
                  </div>
                </div>
              </div>
    ...
    <div class="mt-5 colch container col-md-12">
        <h2 style="color: #fff !important;" class="fw-bold text-body-emphasis lh-1 mb-3 chtsb">Cheat subscription<br>plans</h2>
                ...
                ">
                    ...
                    <a style="margin-left: 5px;" href="/my/login" class="nav__link"><a id="btn4" onclick="changePrice('btn4', '80')"class="buybtn btnbuypage">Lifetime</a></a>
                  </div>
                        ...
                        <div style="background-color: #020b1c; border-color: #020b1c; border-radius: 22px;" class="card">
                            <div class="card-body">
                                <center><h5>Price</h5>
                                    ...
                                    <a style="margin-left: 15px;" href="/my/login" class="nav__link"><a href="/my/buy?id=csgo2" id="btnbuy" class="loginbtn">Buy</a></a></center>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-5">
...
<script>
  ...
  function changePrice(btnid, price) {
      if (btnid === 'btn1') {
        ...
        document.getElementById('price').innerHTML = '<b style="color: #246bf4; font-weight: 500;"><?=$valic?></b>3';
        document.getElementById('btnbuy').setAttribute("href", "/my/buy?id=csgo1");
      }
      ...
      if (btnid === 'btn2') {
        ...
        document.getElementById('price').innerHTML = '<b style="color: #246bf4; font-weight: 500;"><?=$valic?></b>15';
        document.getElementById('btnbuy').setAttribute("href", "/my/buy?id=csgo2");
      }
      ...
      if (btnid === 'btn3') {
        ...
        document.getElementById('price').innerHTML = '<b style="color: #246bf4; font-weight: 500;"><?=$valic?></b>25';
        document.getElementById('btnbuy').setAttribute("href", "/my/buy?id=csgo3");
      }
      ...
      if (btnid === 'btn4') {
        ...
        document.getElementById('price').innerHTML = '<b style="color: #246bf4; font-weight: 500;"><?=$valic?></b>75';
        document.getElementById('btnbuy').setAttribute("href", "/my/buy?id=csgo4");
      }

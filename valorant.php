...
<body style="
background-image: url('/static/img/bck.png') !important;
...
?>
  ...
  <div class="col-lg-6">
        <?php
    if ((int)$data_tvt['valorant'] === 1) {
        $text = 'Undetected';
        $color = '#86FF0D'; 
    } else if ((int)$data_tvt['valorant'] === 2) {
        $text = 'Updating';
        $color = '#f4900c'; 
    } else {
        $text = 'Detected';
    ...
    ?>
        <p style="font-size: 17px;"><b style="color: <?=$color?>; font-weight: 400; margin-left: 20px;">
            ...
            <circle cx="5" cy="5" r="5" fill="<?=$color?>"/> <?=$text?>
             ...
             <?=$text?></b></p>
      <h1 style="color: #fff !important; font-size: 75px;" class="fw-bold text-body-emphasis lh-1 mb-3"><img style="margin-right: 10px;" width="60" src="/static/img/vlic.png">Valorant</h1>
      <p style="font-size: 20px; color: #aca6a7; margin-top: 20px; margin-bottom: 20px;">Introducing Aworex – Your Ultimate Valorant Advantage!<br><br>

Step into the world of Valorant with Aworex, your premium solution for unparalleled enhancements. Aworex empowers you to navigate the intense challenges of Valorant. Our state-of-the-art features are fortified by advanced security protocols, providing you with the tools you need to excel without compromising your account. Join our community today and experience Valorant in a whole new light with Aworex.</p>
      
    </div>
    <div class="col-10 col-sm-8 col-lg-6">
        <video style="width: 100% !important; margin-top: 30px;" src="/static/valorant.mp4" class="d-block imgFullItem" controls="" autoplay="" muted=""></video>
    </div>
  </div>
  </div>
  <div class="container col-xxl-8 mt-5">
    <h1 style="color: #fff !important; font-size: 75px;" class="fw-bold text-body-emphasis lh-1 mb-3">Functions</h1>
  </div>
  <div class="container col-xxl-8 mt-5">
    <div class="row">
      <div class="col-lg-6">
          <div class="row">
           <center> <h4><b>VISUAL</b></h4></center>
            ...
            <div  style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
              ...
              <div  style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
                ...
                <div style="background-color: #020b1c;" id="collapseOnett" class="accordion-collapse  show" aria-labelledby="headingOnett" data-bs-parent="#accordionExample">
                  <div style="color: #afa6a8; margin-top: -20px;" class="accordion-body">
                      will trigger a horizontal mine on the opponents head
                  </div>
                </div>
              </div>
              ...
              <div  style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
                ...
                <div style="background-color: #020b1c;" id="collapseOnett" class="accordion-collapse  show" aria-labelledby="headingOnett" data-bs-parent="#accordionExample">
                  <div style="color: #afa6a8; margin-top: -20px;" class="accordion-body">
                      will show the health of your opponents
                  </div>
                </div>
              </div>
              ...
              <div  style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
                ...
                <div style="background-color: #020b1c;" id="collapseOnett" class="accordion-collapse  show" aria-labelledby="headingOnett" data-bs-parent="#accordionExample">
                  <div style="color: #afa6a8; margin-top: -20px;" class="accordion-body">
                      will draw a mini "map" in the upper left corner, where you will see your opponents
                  </div>
                </div>
              </div>
              <div  style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
                ...
                <div style="background-color: #020b1c;" id="collapseOnett" class="accordion-collapse  show" aria-labelledby="headingOnett" data-bs-parent="#accordionExample">
                  <div style="color: #afa6a8; margin-top: -20px;" class="accordion-body">
                      will increase/decrease radar size
                  </div>
                </div>
              </div>
      ...
      <center><h4><b>AIM</b></h4></center>
        <div class="accordion" id="accordionExample">
            ...
            <div  style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
                ...
                <div style="background-color: #020b1c;" id="collapseOnet" class="accordion-collapse  show" aria-labelledby="headingOnet" data-bs-parent="#accordionExample">
                  <div style="color: #afa6a8; margin-top: -20px;" class="accordion-body">
                      Hitbox: allows you to set the preference where your crosshairs will pull
                  </div>
                </div>
              </div>
              <div  style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
    ...
    <div class="mt-5 colch container col-md-12">
        <h1 style="color: #fff !important;" class="fw-bold text-body-emphasis lh-1 mb-3 chtsb">Cheat subscription<br>plans</h1>
                ...
                ">
                    <a href="/my/login" class="nav__link"><a id="btn1" onclick="changePrice('btn1', '7')" class="buybtn btnbuypage">1 day</a></a>
                    <a style="margin-left: 5px;" href="/my/login" class="nav__link"><a id="btn2" onclick="changePrice('btn2', '35')" class="loginbtn btnbuypage">7 day</a></a>
                    <a style="margin-left: 5px;" href="/my/login" class="nav__link"><a id="btn3" onclick="changePrice('btn3', '99')"class="buybtn btnbuypage">30 days</a></a>
                  </div>
                        ...
                        <div style="background-color: #020b1c; border-color: #020b1c; border-radius: 22px;" class="card">
                            <div class="card-body">
                                <center><h5>Price</h5>
                                    ...
                                    <a style="margin-left: 15px;" href="/my/login" class="nav__link"><a href="/my/buy?id=valorant2" id="btnbuy" class="loginbtn">Buy</a></a></center>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-5">
...
<script>
  ...
  function changePrice(btnid, price) {
      if (btnid === 'btn1') {
        ...
        document.getElementById('btnbuy').setAttribute("href", "/my/buy?id=valorant1");
      }
      ...
      if (btnid === 'btn2') {
        ...
        document.getElementById('btnbuy').setAttribute("href", "/my/buy?id=valorant2");
      }
      ...
      if (btnid === 'btn3') {
        ...
        document.getElementById('btnbuy').setAttribute("href", "/my/buy?id=valorant3");
      }

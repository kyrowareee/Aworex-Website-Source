...
background-repeat: no-repeat; background-size: cover; background-color: #0e0306;">
<?php
...
?>
    ...
    <div class=" container col-xxl-8 px-4 py-5">
        <div class="row">
            ...
            <div class="col-md-6"><img src="/static/img/spoofer.png" style="width: 700px !important" width="600" alt=""></div>
            
            <div class="col-md-3"></div>
            <h1 id="contact" class="price__header" style="font-size: 45px; margin-top: -35px; text-align: center;">Update</h1>
        <div class="col-md-3"></div>
         ...
         <div style="margin-left: 55px;" class="col-md-6"><a href="/my/buy?id=update" class="loginbtn">Buy</a></div>
   <div class="col-3"></div>
        </div>
  </div>

...
<body style="
background-image: url('/static/img/gtabck.png') !important;
background-repeat: no-repeat; background-color: #020711; background-size: cover;">
    ...
    ?>
        <p style="font-size: 17px;"><b style="color: <?=$color?>; font-weight: 400; margin-left: 20px;">
            ...
            <circle cx="5" cy="5" r="5" fill="<?=$color?>"/> <?=$text?>
             ...
             <?=$text?></b></p>
      <h1 style="color: #fff !important; font-size: 75px;" class="fw-bold text-body-emphasis lh-1 mb-3"><img style="margin-right: 10px;" width="60" src="/static/img/fivem.png">FiveM</h1>
      <p style="font-size: 20px; color: #aca6a7; margin-top: 20px; margin-bottom: 20px;">
Welcome to Aworex – Your Leading Edge for FiveM Mastery!<br><br>

Explore the immersive world of FiveM with an upper hand as we introduce the finest cheats to elevate your gameplay. Step into a realm of boundless possibilities with the assurance that our undetected hacks will keep you safe from bans. At Aworex, we prioritize your gaming security with advanced measures designed to give you peace of mind.

Unlock the full potential of FiveM with our reliable cheats, and become a part of an elite community where excellence meets performance. Discover new strategies, dominate in every scenario, and experience the thriving metropolis of FiveM like never before. Choose Aworex for your FiveM adventures and redefine your gaming experience.
</p>
    </div>
    <div class="col-10 col-sm-8 col-lg-6">
        <video style="width: 75% !important; margin-top: 30px;" src="/static/fivem1.mp4" class="d-block imgFullItem" controls="" autoplay="" muted=""></video>
        <video style="width: 75% !important; margin-top: 30px;" src="/static/fivem2.mp4" class="d-block imgFullItem" controls="" autoplay="" muted=""></video>
    </div>
  </div>
  </div>
      ...
      <div class="col-lg-8 container">
       ...
       <div class="col-md-12">
            <div  style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
              ...
              <b>Draw FOV</b> <i style="margin-left: 9px; color: #246bf4" class="bi bi-chevron-up"></i>
                </button>
              </h2>
            ...
            <div  style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
              <h2 class="accordion-header" id="headingOne">
                <button style="background-color: #020b1c; color: #246bf4" class="accordion-button" type="button">
              <b>Fov adjustment</b> <i style="margin-left: 9px; color: #246bf4" class="bi bi-chevron-up"></i>
                </button>
              </h2>
            ...
            <div  style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
              <h2 class="accordion-header" id="headingOne">
                <button style="background-color: #020b1c; color: #246bf4" class="accordion-button" type="button">
              <b>Hitboxes | Head, Neck, Chest</b> <i style="margin-left: 9px; color: #246bf4" class="bi bi-chevron-up"></i>
                </button>
              </h2>
            ...
            <div  style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
              <h2 class="accordion-header" id="headingOne">
                <button style="background-color: #020b1c; color: #246bf4" class="accordion-button" type="button">
              <b>Aimbot smoothing & Distance</b> <i style="margin-left: 9px; color: #246bf4" class="bi bi-chevron-up"></i>
                </button>
              </h2>
            ...
            <div  style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
              <h2 class="accordion-header" id="headingOne">
                <button style="background-color: #020b1c; color: #246bf4" class="accordion-button" type="button">
              <b>Ignore dead | Peds</b> <i style="margin-left: 9px; color: #246bf4" class="bi bi-chevron-up"></i>
                </button>
              </h2>
       ...
       <div class="col-md-12">
            <div  style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
              <h2 class="accordion-header" id="headingOne">
                <button style="background-color: #020b1c; color: #246bf4" class="accordion-button" type="button">
              <b>Box ESP</b> <i style="margin-left: 9px; color: #246bf4" class="bi bi-chevron-up"></i>
                </button>
              </h2>
            ...
            <div  style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
              <h2 class="accordion-header" id="headingOne">
                <button style="background-color: #020b1c; color: #246bf4" class="accordion-button" type="button">
              <b>Filled Box Gradient ESP</b> <i style="margin-left: 9px; color: #246bf4" class="bi bi-chevron-up"></i>
                </button>
              </h2>
            ...
            <div  style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
              <h2 class="accordion-header" id="headingOne">
                <button style="background-color: #020b1c; color: #246bf4" class="accordion-button" type="button">
              <b>Distance ESP</b> <i style="margin-left: 9px; color: #246bf4" class="bi bi-chevron-up"></i>
                </button>
              </h2>
            ...
            <div  style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
              <h2 class="accordion-header" id="headingOne">
                <button style="background-color: #020b1c; color: #246bf4" class="accordion-button" type="button">
              <b>Skeleton ESP</b> <i style="margin-left: 9px; color: #246bf4" class="bi bi-chevron-up"></i>
                </button>
              </h2>
            ...
            <div  style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
              <h2 class="accordion-header" id="headingOne">
                <button style="background-color: #020b1c; color: #246bf4" class="accordion-button" type="button">
              <b>Player ID</b> <i style="margin-left: 9px; color: #246bf4" class="bi bi-chevron-up"></i>
                </button>
              </h2>
            ...
            <div  style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
              <h2 class="accordion-header" id="headingOne">
                <button style="background-color: #020b1c; color: #246bf4" class="accordion-button" type="button">
              <b>Snaplines</b> <i style="margin-left: 9px; color: #246bf4" class="bi bi-chevron-up"></i>
                </button>
              </h2>
            ...
            <div  style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
              <h2 class="accordion-header" id="headingOne">
                <button style="background-color: #020b1c; color: #246bf4" class="accordion-button" type="button">
              <b>Health Bar</b> <i style="margin-left: 9px; color: #246bf4" class="bi bi-chevron-up"></i>
                </button>
              </h2>
            ...
            <div  style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
              <h2 class="accordion-header" id="headingOne">
                <button style="background-color: #020b1c; color: #246bf4" class="accordion-button" type="button">
              <b>Distance adjustment</b> <i style="margin-left: 9px; color: #246bf4" class="bi bi-chevron-up"></i>
                </button>
              </h2>
       ...
       <div class="col-md-12">
            <div  style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
              <h2 class="accordion-header" id="headingOne">
                <button style="background-color: #020b1c; color: #246bf4" class="accordion-button" type="button">
              <b>Godmode</b> <i style="margin-left: 9px; color: #246bf4" class="bi bi-chevron-up"></i>
                </button>
              </h2>
            ...
            <div  style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
              <h2 class="accordion-header" id="headingOne">
                <button style="background-color: #020b1c; color: #246bf4" class="accordion-button" type="button">
              <b>Infinite Armor</b> <i style="margin-left: 9px; color: #246bf4" class="bi bi-chevron-up"></i>
                </button>
              </h2>
            ...
            <div  style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
              <h2 class="accordion-header" id="headingOne">
                <button style="background-color: #020b1c; color: #246bf4" class="accordion-button" type="button">
              <b>Invis</b> <i style="margin-left: 9px; color: #246bf4" class="bi bi-chevron-up"></i>
                </button>
              </h2>
            ...
            <div  style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
              <h2 class="accordion-header" id="headingOne">
                <button style="background-color: #020b1c; color: #246bf4" class="accordion-button" type="button">
              <b>Infinite Stam</b> <i style="margin-left: 9px; color: #246bf4" class="bi bi-chevron-up"></i>
                </button>
              </h2>
            ...
            <div  style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
              <h2 class="accordion-header" id="headingOne">
                <button style="background-color: #020b1c; color: #246bf4" class="accordion-button" type="button">
              <b>Fov changer</b> <i style="margin-left: 9px; color: #246bf4" class="bi bi-chevron-up"></i>
                </button>
              </h2>
            ...
            <div  style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
              <h2 class="accordion-header" id="headingOne">
                <button style="background-color: #020b1c; color: #246bf4" class="accordion-button" type="button">
              <b>Speed changer</b> <i style="margin-left: 9px; color: #246bf4" class="bi bi-chevron-up"></i>
                </button>
              </h2>
            ...
            <div  style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
              <h2 class="accordion-header" id="headingOne">
                <button style="background-color: #020b1c; color: #246bf4" class="accordion-button" type="button">
              <b>Explosive ammunition</b> <i style="margin-left: 9px; color: #246bf4" class="bi bi-chevron-up"></i>
                </button>
              </h2>
            ...
            <div  style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
              <h2 class="accordion-header" id="headingOne">
                <button style="background-color: #020b1c; color: #246bf4" class="accordion-button" type="button">
              <b>Noclipping</b> <i style="margin-left: 9px; color: #246bf4" class="bi bi-chevron-up"></i>
                </button>
              </h2>
            ...
            <div  style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
              <h2 class="accordion-header" id="headingOne">
                <button style="background-color: #020b1c; color: #246bf4" class="accordion-button" type="button">
              <b>Self heal / Button</b> <i style="margin-left: 9px; color: #246bf4" class="bi bi-chevron-up"></i>
                </button>
              </h2>
            ...
            <div  style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
              <h2 class="accordion-header" id="headingOne">
                <button style="background-color: #020b1c; color: #246bf4" class="accordion-button" type="button">
              <b>Scripts | Executor</b> <i style="margin-left: 9px; color: #246bf4" class="bi bi-chevron-up"></i>
                </button>
              </h2>
                        ...
                        <div style="background-color: #020b1c; border-color: #020b1c; border-radius: 22px;" class="card">
                            <div class="card-body">
                                <center><h5>Price</h5>
                                    ...
                                    <a style="margin-left: 15px;" href="/my/login" class="nav__link"><a href="/my/buy?id=valk2" id="btnbuy" class="loginbtn">Buy</a></a></center>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-5">
...
<script>
  ...
  function changePrice(btnid, price) {
      if (btnid === 'btn1') {
        ...
        document.getElementById('btnbuy').setAttribute("href", "/my/buy?id=fivem1");
      }
      ...
      if (btnid === 'btn2') {
        ...
        document.getElementById('btnbuy').setAttribute("href", "/my/buy?id=fivem2");
      }
      ...
      if (btnid === 'btn3') {
        ...
        document.getElementById('btnbuy').setAttribute("href", "/my/buy?id=fivem3");
      }
      ...
      if (btnid === 'btn4') {
        ...
        document.getElementById('btnbuy').setAttribute("href", "/my/buy?id=fivem4");
      }
...
<section style="background: none;" class="footer"><a class="d-flex instructionRun" href="javascript:void(0);">
	...
	<div class="footer__container"><a class="d-flex instructionRun" href="javascript:void(0);">
            ...
            </a><a  href="/blog" class="footer__developer">Blog

                </a>
                <a href="/support" class="footer__developer">Support

                </a>
                <p class="footer__developer">Aworex © 2024 • <a class="footer__developer" href="/terms">Terms</a></p>

                </a>
                <a href="/spoofer" class="footer__developer">Spoofer

                </a>
            <div class="footer_dev"><a class="d-flex instructionRun" href="javascript:void(0);">
                </a>
                <a href="/cs2" class="footer__developer">CS2

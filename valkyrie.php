    ...
    ?>
        <p style="font-size: 17px;"><b style="color: <?=$color?>; font-weight: 400; margin-left: 20px;">
            ...
            <circle cx="5" cy="5" r="5" fill="<?=$color?>"/> <?=$text?>
             ...
             <?=$text?></b></p>
      <h1 style="color: #fff !important; font-size: 75px;" class="fw-bold text-body-emphasis lh-1 mb-3"><img style="margin-right: 10px;" width="60" src="/static/img/eft.png">Valkyrie</h1>
      <p style="font-size: 20px; color: #aca6a7; margin-top: 20px; margin-bottom: 20px;">

Valkyrie is the premier cheat designed to elevate your Escape from Tarkov experience. Immerse yourself in the game's world with confidence, knowing that Aworex brings unparalleled enhancements. Our features are backed by robust security measures, ensuring you that you won't get banned. Join our community and explore Tarkov like never before with Valkyrie.</p>
    </div>
    <div class="col-10 col-sm-8 col-lg-6">
        <video style="width: 100% !important; margin-top: 30px;" src="/static/valkyria.mp4" class="d-block imgFullItem" controls="" autoplay="" muted=""></video>
    </div>
  </div>
  </div>
  ...
  <div class="container">
      ...
      <div class="col-lg-8 container">
        ...
        <div class="row">
            ...
            <div  style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
              ...
              <b>Infinite Stamina</b> <i style="margin-left: 9px; color: #246bf4" class="bi bi-chevron-up"></i>
                </button>
              </h2>
            ...
            <div  style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
                ...
                <b>Instant search</b> <i style="margin-left: 9px; color: #246bf4" class="bi bi-chevron-up"></i>
                  </div>
                </h2>
              ...
              <div  style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
                ...
                <b>No Sway</b> <i style="margin-left: 9px; color: #246bf4" class="bi bi-chevron-up"></i>
                  </div>
                </h2>
    ...
    <h2 class="accordion-header" id="headingOnettt">
        <div style="background-color: #020b1c; color: #246bf4" class="accordion-button" type="button">
            <b>No weapon malfunction</b> <i style="margin-left: 9px; color: #246bf4" class="bi bi-chevron-up"></i>
        </div>
    </h2>
</div>
</div>
...
<div style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
    <h2 class="accordion-header" id="headingOnettt">
        <div style="background-color: #020b1c; color: #246bf4" class="accordion-button" type="button">
            <b>No Recoil</b> <i style="margin-left: 9px; color: #246bf4" class="bi bi-chevron-up"></i>
        </div>
    </h2>
</div>
</div>
...
<div style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
    <h2 class="accordion-header" id="headingOnettt">
        <div style="background-color: #020b1c; color: #246bf4" class="accordion-button" type="button">
            <b>No Visor</b> <i style="margin-left: 9px; color: #246bf4" class="bi bi-chevron-up"></i>
        </div>
    </h2>
</div></div>
  <div class="col-md-4">
<div style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
    <h2 class="accordion-header" id="headingOnettt">
        <div style="background-color: #020b1c; color: #246bf4" class="accordion-button" type="button">
            <b>Zoom helper</b> <i style="margin-left: 9px; color: #246bf4" class="bi bi-chevron-up"></i>
        </div>
    </h2>
</div></div>
  <div class="col-md-4">
<div style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
    <h2 class="accordion-header" id="headingOnettt">
        <div style="background-color: #020b1c; color: #246bf4" class="accordion-button" type="button">
            <b>Normal FOV selector</b> <i style="margin-left: 9px; color: #246bf4" class="bi bi-chevron-up"></i>
        </div>
    </h2>
</div></div>
  <div class="col-md-4">
<div style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
    <h2 class="accordion-header" id="headingOnettt">
        <div style="background-color: #020b1c; color: #246bf4" class="accordion-button" type="button">
            <b>Aiming FOV selector</b> <i style="margin-left: 9px; color: #246bf4" class="bi bi-chevron-up"></i>
        </div>
    </h2>
</div></div>
...
<div style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
    <h2 class="accordion-header" id="headingOnettt">
        <div style="background-color: #020b1c; color: #246bf4" class="accordion-button" type="button">
            <b>Modify Recoil</b> <i style="margin-left: 9px; color: #246bf4" class="bi bi-chevron-up"></i>
        </div>
    </h2>
</div></div>
  <div class="col-md-4">
<div style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
    <h2 class="accordion-header" id="headingOnettt">
        <div style="background-color: #020b1c; color: #246bf4" class="accordion-button" type="button">
            <b>Recoil Percent selector</b> <i style="margin-left: 9px; color: #246bf4" class="bi bi-chevron-up"></i>
        </div>
    </h2>
</div></div>
  <div class="col-md-4">
<div style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
    <h2 class="accordion-header" id="headingOnettt">
        <div style="background-color: #020b1c; color: #246bf4" class="accordion-button" type="button">
            <b>No Pain Effects</b> <i style="margin-left: 9px; color: #246bf4" class="bi bi-chevron-up"></i>
        </div>
    </h2>
</div></div>
  <div class="col-md-4">
<div style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
    <h2 class="accordion-header" id="headingOnettt">
        <div style="background-color: #020b1c; color: #246bf4" class="accordion-button" type="button">
            <b>Quick mag load/unload</b> <i style="margin-left: 9px; color: #246bf4" class="bi bi-chevron-up"></i>
        </div>
    </h2>
</div></div>
  <div class="col-md-4">
<div style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
    <h2 class="accordion-header" id="headingOnettt">
        <div style="background-color: #020b1c; color: #246bf4" class="accordion-button" type="button">
            <b>Loot thru walls</b> <i style="margin-left: 9px; color: #246bf4" class="bi bi-chevron-up"></i>
        </div>
    </h2>
</div>
</div>
...
<div style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
    <h2 class="accordion-header" id="headingOnettt">
        <div style="background-color: #020b1c; color: #246bf4" class="accordion-button" type="button">
            <b>No Sprint Inertia</b> <i style="margin-left: 9px; color: #246bf4" class="bi bi-chevron-up"></i>
        </div>
    </h2>
</div>
</div
...
<script>
  ...
  function changePrice(btnid, price) {
      if (btnid === 'btn1') {
        ...
        document.getElementById('btnbuy').setAttribute("href", "/my/buy?id=valk1");
      }
      ...
      if (btnid === 'btn2') {
        ...
        document.getElementById('btnbuy').setAttribute("href", "/my/buy?id=valk2");
      }
      ...
      if (btnid === 'btn3') {
        ...
        document.getElementById('btnbuy').setAttribute("href", "/my/buy?id=valk3");
      }
      ...
      if (btnid === 'btn4') {
        ...
        document.getElementById('btnbuy').setAttribute("href", "/my/buy?id=valk4");
      }

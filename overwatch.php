...
<body style="
background-image: url('/static/img/bckov.png') !important;
...
?>
  ...
  <div class="row align-items-center g-5 py-5">
    ...
    <div class="col-lg-6">
        <?php
    if ((int)$data_tvt['overwatch'] === 1) {
        $text = 'Undetected';
        $color = '#86FF0D'; 
    } else if ((int)$data_tvt['overwatch'] === 2) {
        $text = 'Updating';
        $color = '#f4900c'; 
    } else {
        $text = 'Detected';
    ...
    ?>
        <p style="font-size: 17px;"><b style="color: <?=$color?>; font-weight: 400; margin-left: 20px;">
            ...
            <circle cx="5" cy="5" r="5" fill="<?=$color?>"/> <?=$text?>
             ...
             <?=$text?></b></p>
      <h1 style="color: #fff !important; font-size: 75px;" class="fw-bold text-body-emphasis lh-1 mb-3"><img style="margin-right: 10px;" width="60" src="/static/img/ovic.png">Overwatch</h1>
      <p style="font-size: 20px; color: #aca6a7; margin-top: 20px; margin-bottom: 20px;">Welcome to Aworex – Your Overwatch 2 Game Advantage!<br><br>

Aworex is the ultimate cheat designed to give you the edge in Overwatch 2. Immerse yourself in the world of Overwatch 2 with confidence, knowing that Aworex provides unmatched enhancements. Our advanced features are fortified by robust security measures, ensuring you can play with peace of mind. Join our community and redefine your Overwatch 2 journey with Aworex.</p>
    ...
    <div class="col-10 col-sm-8 col-lg-6">
        <video style="width: 100% !important; margin-top: 30px;" src="/static/overwatch.mp4" class="d-block imgFullItem" controls="" autoplay="" muted=""></video>
    </div>
  </div>
  </div>
           ...
           <div  style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
              ...
              <div style="background-color: #020b1c;" id="collapseOne" class="accordion-collapse  show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                <div style="color: #afa6a8; margin-top: -20px;" class="accordion-body">
                     being able to see your enemies through any obstacle is distance, being able to choose key to activate and variable colors
                </div>
              </div>
            </div>
            <div  style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
                ...
                <div style="background-color: #020b1c;" id="collapseOnet" class="accordion-collapse  show" aria-labelledby="headingOnet" data-bs-parent="#accordionExample">
                  <div style="color: #afa6a8; margin-top: -20px;" class="accordion-body">
                      like any other aimbot, it is possible to configure the Hitbox and also the fov
                  </div>
                </div>
              </div>
          </div>
...
<script>
  ...
  function changePrice(btnid, price) {
      if (btnid === 'btn1') {
        ...
        document.getElementById('btnbuy').setAttribute("href", "/my/buy?id=ov1");
      }
      ...
      if (btnid === 'btn2') {
        ...
        document.getElementById('btnbuy').setAttribute("href", "/my/buy?id=ov2");
      }
      ...
      if (btnid === 'btn3') {
        ...
        document.getElementById('btnbuy').setAttribute("href", "/my/buy?id=ov3");
      }
      ...
      if (btnid === 'btn4') {
        ...
        document.getElementById('btnbuy').setAttribute("href", "/my/buy?id=ov4");
      }

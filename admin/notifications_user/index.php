...
<link rel="stylesheet" href="/static/css/root.admin.css">
    ...
    <body>
    <?php 
    if (isset($_GET["sort"])) { $ty = '/api/Notifications/List?sort='.$_GET['sort']; } else {$ty = '/api/Notifications/List'; }
    ?>
    <script>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
                <center><h1 class="h3 mb-3 mt-4 fw-normal text-center">Add Notification</h1></center>
            <div class="modal-body">
            <form id="reviewAdd" method="post">
       <div class="mb-3">
  <label for="exampleFormControlInput1" class="form-label">Title</label>
  <input id="keystr" name="title" type="text" class="form-control" id="exampleFormControlInput1">
</div>     
<div class="mb-3">
  <label for="exampleFormControlInput1" class="form-label">Key</label>
  <textarea id="keystr" name="text" type="text" class="form-control" id="exampleFormControlInput1"></textarea>
</div>
...
function generate(reqsum)
{
    ...
    while (1){
       ...
       <div id="chatc">
       <?php
        $reviews = DBA::query("SELECT * FROM notifications ORDER BY id DESC");

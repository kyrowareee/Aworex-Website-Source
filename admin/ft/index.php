...
<link rel="stylesheet" href="/static/css/root.admin.css">
    ...
    <body>
    <?php 
    if (isset($_GET["sort"])) { $ty = '/api/Admin/AccountsCheat/FTList?sort='.$_GET['sort']; } else {$ty = '/api/Admin/AccountsCheat/FTList'; }
    ?>
    <script>
            $(document).ready(function() {
                ...
                $('#reviewAdd').submit(function(e) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: '/api/Admin/AccountsCheat/FTAdd',
                        data: formData,
                        processData: false,
            contentType: false,
    ...
    $n = 'EFT';
       ...
       ?>
        ...
        <a style="margin-top: 20px; margin-left: 7px;" data-bs-toggle="modal" href="#" data-bs-target="#reviewModal" class="price__card__button">Add</a>
         ...
         <div class="col-md-auto d-flex align-items-center">
        <a style="margin-bottom: 20px; margin-right: 7px;" href="?sort=cheat" class="btn btn-sm btn-primary">EFT</a>
        <a style="margin-bottom: 20px; margin-right: 7px;" href="?sort=csgo" class="btn btn-sm btn-primary">CS2</a>
        <a style="margin-bottom: 20px; margin-right: 7px;" href="?sort=cheata" class="btn btn-sm btn-primary">EFT: Arena</a>
         <a style="margin-bottom: 20px; margin-right: 7px;" href="?sort=fivem" class="btn btn-sm btn-primary">FiveM</a>
        </div>

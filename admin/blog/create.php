...
if (isset($_POST['createpost'])) {
    ...
    $filePath = pathinfo($file['name']);
        if ($_FILES['filebodymain']['error'] != 4) {
    ...
    DB::query('INSERT INTO blog VALUES (\'0\', :title, :stext, :text, :photourl, :date)', array(':title'=>$_POST['title'], ':stext'=>$_POST['stext'], ':text'=>$_POST['bodypost'], ':photourl'=>$photourl, ':date'=>$unixTimestamp));
    header('Location: index.php');
        } else {
            DB::query('INSERT INTO blog VALUES (\'0\', :title, :stext, :text, :photourl, :date)', array(':title'=>$_POST['title'], ':stext'=>$_POST['stext'], ':text'=>$_POST['bodypost'], ':photourl'=>'NONE', ':date'=>$unixTimestamp));
    header('Location: index.php');
        }
}
?>
...
<div class="modal fade" id="pickVideoModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
 ...
 <input name="stext" id="shorttext" type="text" class="form-control" id="exampleFormControlInput1" value="NONE" hidden>
<div class="mb-3">
...
<div class="mb-3">
  ...
  <input name="filebodymain" class="form-control" type="file" id="formFile">
        ...
        <textarea id="bodypost" class="form-control" name="bodypost" placeholder="You can type into your story" cols="30" rows="10"></textarea>

...
if (isset($_POST['createpost'])) {
    DB::query('UPDATE root SET downloadtext=:d, spoofer=:s, cheata=:a, csgo=:c, fivem=:fv WHERE id=1', array(':d'=>$_POST['cheat'], ':s'=>$_POST['spoofer'], ':a'=>$_POST['cheata'], ':c'=>$_POST['csgo'], ':fv'=>$_POST['fivem']));
    header('Location: /admin/instructions');
}
...
<div class="mb-3">
  ...
  <textarea type="text" name="spoofer" class="form-control" id="exampleFormControlInput1"><?=$data['spoofer']?></textarea>
</div>
<div class="mb-3">

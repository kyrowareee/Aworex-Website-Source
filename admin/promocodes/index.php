...
<div class="mb-3">
  ...
  <select name="product">
  <option value="NONE">For all</option>
    <option value="cheat1">EFT 1 day</option>
    <option value="cheat3">EFT 7 days</option>
    <option value="cheat5">EFT 30 days</option>
    <option value="cheat6">EFT Lifetime</option>
    <option value="csgo1">CS2 1 Day</option>
    <option value="csgo2">CS2 7 Days</option>
    <option value="csgo3">CS2 30 Days</option>
    <option value="csgo4">CS2 Lifetime</option>

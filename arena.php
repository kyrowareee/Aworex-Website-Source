...
<head>
<meta name="description" content="Discover the ultimate Escape from Tarkov advantage with undetectable cheats and hacks. Join our private community on Aworex for top-tier Tarkov gaming. Dominate now! | Cs2 Game Cheats Inside.">
    ...
    ?>
        <p style="font-size: 17px;"><b style="color: <?=$color?>; font-weight: 400; margin-left: 20px;">
            ...
            <circle cx="5" cy="5" r="5" fill="<?=$color?>"/> <?=$text?>
             ...
             <?=$text?></b></p>
      <h1 style="color: #fff !important; font-size: 75px;" class="fw-bold text-body-emphasis lh-1 mb-3"><img style="margin-right: 10px;" width="80" src="/static/img/efta.png">Escape From Tarkov: Arena</h1>
...
The premier Escape from Tarkov cheat. Immerse yourself in the game's world with confidence, knowing that our undetected hack brings unparalleled safety. Our features are backed by robust security measures, ensuring you that you won't get banned. Buy Cheats for Tarkov and join our community and explore Tarkov like never before with Aworex.</p>
    ...
    <div class="col-10 col-sm-8 col-lg-6">
        <video style="width: 100% !important; margin-top: 30px;" src="/static/arena.mp4" class="d-block imgFullItem" controls="" autoplay="" muted=""></video>
    </div>
  </div>
  </div>
            ...
            <div  style="border-color: #020b1c; margin-bottom: 15px; " class="accordion-item">
              ...
              <div style="background-color: #020b1c;" id="collapseOne" class="accordion-collapse  show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                <div style="color: #afa6a8;" class="accordion-body">
                    You are able to easily see your opponents through any 
walls/surfaces which will help you to eliminate your opponents 
and successfully complete a raid.
                </div>
              </div>
            </div>
                        ...
                        <div style="background-color: #020b1c; border-color: #020b1c; border-radius: 22px;" class="card">
                            <div class="card-body">
                                <center><h5>Price</h5>
                                    ...
                                    <a style="margin-left: 15px;" href="/my/login" class="nav__link"><a href="/my/buy?id=arena2" id="btnbuy" class="loginbtn">Buy</a></a></center>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-5">
...
<script>
  ...
  function changePrice(btnid, price) {
      if (btnid === 'btn1') {
        ...
        document.getElementById('btnbuy').setAttribute("href", "/my/buy?id=arena1");
      }
      ...
      if (btnid === 'btn2') {
        ...
        document.getElementById('btnbuy').setAttribute("href", "/my/buy?id=arena2");
      }
      ...
      if (btnid === 'btn3') {
        ...
        document.getElementById('btnbuy').setAttribute("href", "/my/buy?id=arena3");
      }
      ...
      if (btnid === 'btn4') {
        ...
        document.getElementById('btnbuy').setAttribute("href", "/my/buy?id=arena4");
      }

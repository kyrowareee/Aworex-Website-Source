...
<head>
<meta name="description" content="Dominate in Escape from Tarkov with Aworex's superior gaming tools. Get ahead of the curve and maximize your potential with our advanced features, all available to you during our special 3-hour free trial period.">
<meta name="keywords" content="Undetectable Tarkov Cheats, Hack for Tarkov Arena, Hacks For Escape from Tarkov, Escape From Tarkov Private Hack, Escape From Tarkov Cheats Discord, Escape From, Tarkov Private Cheats, How To Cheat in Escape from Tarkov, Chart For Escape from Tarkov Arena">
...
.fancybox__container.has-slideshow .fancybox__button--slideshow g:nth-child(2) {
  ...
  <title>Best Undetectable Tarkov Cheats and Hacks | Aworex</title>
...
<body style="
background-image: url('/static/img/bck152.png') !important;
background-repeat: no-repeat; background-color: #020711; background-size: contain;">
...
?>
  ...
  <div class="row align-items-center g-5 py-5">
    ...
    <div class="col-lg-6">
        <?php
    if ((int)$data_tvt['cheat'] === 1) {
        $text = 'Undetected';
        $color = '#86FF0D'; 
    } else if ((int)$data_tvt['cheat'] === 2) {
        $text = 'Updating';
        $color = '#f4900c'; 
    } else {
        $text = 'Detected';
    ...
    ?>
        <p style="font-size: 17px;"><b style="color: <?=$color?>; font-weight: 400; margin-left: 20px;">
            <svg style="margin-right: 7px;" width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
            <circle cx="5" cy="5" r="5" fill="<?=$color?>"/> <?=$text?>
            </svg>
             <?=$text?></b></p>
      <h1 style="color: #fff !important; font-size: 75px;" class="fw-bold text-body-emphasis lh-1 mb-3"><img style="margin-right: 10px;" width="60" src="/static/img/eft.png">Escape From Tarkov: Premium</h1>
      <p style="font-size: 20px; color: #aca6a7; margin-top: 20px; margin-bottom: 20px;">Welcome to Aworex – Your Ultimate Escape from Tarkov Companion!<br><br>

The premier Escape from Tarkov cheat. Immerse yourself in the game's world with confidence, knowing that our undetected hack brings unparalleled safety. Our features are backed by robust security measures, ensuring you that you won't get banned. Buy Cheats for Tarkov and join our community and explore Tarkov like never before with Aworex.</p>
    ...
    <div class="col-10 col-sm-8 col-lg-6">
        <video style="width: 100% !important; margin-top: 30px;" src="/index_files/video.mp4" class="d-block imgFullItem" controls="" autoplay="" muted=""></video>
    </div>
  </div>
  </div>
  ...
  <div class="container">
    <div class="row flex-lg-row-reverse">
      <div class="col-lg-8 container">
        ...
        <div class="row">
       <div class="col-md-4">
       <center><b style="font-size: 22px;">Aimbot</b></center>
       <div class="col-md-12">
            <div  style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
              ...
              <b>AimHuman</b><br> <i style="margin-left: 9px; color: #246bf4" class="bi bi-chevron-up"></i>
              
                </button>
                
              </h2>
              <div style="color: #afa6a8; background-color: #020b1c;" class="accordion-body">
Emulates player aiming
</div>
            ...
            <div  style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
              <h2 class="accordion-header" id="headingOne">
                <button style="background-color: #020b1c; color: #246bf4" class="accordion-button" type="button">
              <b>Circle Fov</b> <i style="margin-left: 9px; color: #246bf4" class="bi bi-chevron-up"></i>
                </button>
              </h2>
              <div style="color: #afa6a8; background-color: #020b1c;" class="accordion-body">
Aimbot action radius
</div>
            </div>
            </div>
             <div class="col-md-12">
            <div  style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
              <h2 class="accordion-header" id="headingOne">
                <button style="background-color: #020b1c; color: #246bf4" class="accordion-button" type="button">
              <b>Fov Size</b> <i style="margin-left: 9px; color: #246bf4" class="bi bi-chevron-up"></i>
                </button>
              </h2>
              <div style="color: #afa6a8; background-color: #020b1c;" class="accordion-body">
Size of the aimbot action area
</div>
            </div>
            </div>
             <div class="col-md-12">
            <div  style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
              <h2 class="accordion-header" id="headingOne">
                <button style="background-color: #020b1c; color: #246bf4" class="accordion-button" type="button">
              <b>Fast Load/Unload</b> <i style="margin-left: 9px; color: #246bf4" class="bi bi-chevron-up"></i>
                </button>
              </h2>
              <div style="color: #afa6a8; background-color: #020b1c;" class="accordion-body">
Quick reload
            ...
            <div  style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
              <h2 class="accordion-header" id="headingOne">
                <button style="background-color: #020b1c; color: #246bf4" class="accordion-button" type="button">
              <b>Fast Check Magazine</b> <i style="margin-left: 9px; color: #246bf4" class="bi bi-chevron-up"></i>
                </button>
              </h2>
              <div style="color: #afa6a8; background-color: #020b1c;" class="accordion-body">
Instant magazine check
</div>
            </div>
            </div>
            <div class="col-md-12">
            <div  style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
              <h2 class="accordion-header" id="headingOne">
                <button style="background-color: #020b1c; color: #246bf4" class="accordion-button" type="button">
              <b>Fast Scope</b> <i style="margin-left: 9px; color: #246bf4" class="bi bi-chevron-up"></i>
                </button>
              </h2>
              <div style="color: #afa6a8; background-color: #020b1c;" class="accordion-body">
Instant aiming
            ...
            <div  style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
              <h2 class="accordion-header" id="headingOne">
                <button style="background-color: #020b1c; color: #246bf4" class="accordion-button" type="button">
              <b>Recoil 0%</b> <i style="margin-left: 9px; color: #246bf4" class="bi bi-chevron-up"></i>
                </button>
              </h2>
              <div style="color: #afa6a8; background-color: #020b1c;" class="accordion-body">
Sets recoil to zero
            ...
            <div  style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
              <h2 class="accordion-header" id="headingOne">
                <button style="background-color: #020b1c; color: #246bf4" class="accordion-button" type="button">
              <b>Spread 0%</b> <i style="margin-left: 9px; color: #246bf4" class="bi bi-chevron-up"></i>
                </button>
              </h2>
              <div style="color: #afa6a8; background-color: #020b1c;" class="accordion-body">
Sets the aim steadiness to zero
</div>
            </div>
            </div>
            <div class="col-md-12">
            <div  style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
              <h2 class="accordion-header" id="headingOne">
                <button style="background-color: #020b1c; color: #246bf4" class="accordion-button" type="button">
              <b>Sway 0%</b> <i style="margin-left: 9px; color: #246bf4" class="bi bi-chevron-up"></i>
                </button>
              </h2>
              <div style="color: #afa6a8; background-color: #020b1c;" class="accordion-body">
Sets bullet spread to zero
</div>
            </div>
            </div>
            </div>
             <div class="col-md-4">
              <center><b style="font-size: 22px;">Visuals</b></center>
       <div class="col-md-12">
            <div  style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
              <h2 class="accordion-header" id="headingOne">
                <button style="background-color: #020b1c; color: #246bf4" class="accordion-button" type="button">
              <b>Player esp</b> <i style="margin-left: 9px; color: #246bf4" class="bi bi-chevron-up"></i>
                </button>
              </h2>
              <div style="color: #afa6a8; background-color: #020b1c;" class="accordion-body">
Enable player display
            ...
            <div  style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
              <h2 class="accordion-header" id="headingOne">
                <button style="background-color: #020b1c; color: #246bf4" class="accordion-button" type="button">
              <b>Esp option - Player Box, Name, Weapon, Cost, Side</b> <i style="margin-left: 9px; color: #246bf4" class="bi bi-chevron-up"></i>
                </button>
              </h2>
            ...
            <div  style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
              <h2 class="accordion-header" id="headingOne">
                <button style="background-color: #020b1c; color: #246bf4" class="accordion-button" type="button">
              <b>Enable Chams</b> <i style="margin-left: 9px; color: #246bf4" class="bi bi-chevron-up"></i>
                </button>
              </h2>
              <div style="color: #afa6a8; background-color: #020b1c;" class="accordion-body">
Enable player coloring
</div>
            </div>
            </div>
                   <div class="col-md-12">
            <div  style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
              <h2 class="accordion-header" id="headingOne">
                <button style="background-color: #020b1c; color: #246bf4" class="accordion-button" type="button">
              <b>Chams Type - Wireframe, See Through</b> <i style="margin-left: 9px; color: #246bf4" class="bi bi-chevron-up"></i>
                </button>
              </h2>
            ...
            <div  style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
              <h2 class="accordion-header" id="headingOne">
                <button style="background-color: #020b1c; color: #246bf4" class="accordion-button" type="button">
              <b>Enable Scavs</b> <i style="margin-left: 9px; color: #246bf4" class="bi bi-chevron-up"></i>
                </button>
              </h2>
              <div style="color: #afa6a8; background-color: #020b1c;" class="accordion-body">
Enable display of wild NPCs
</div>
            </div>
            </div>
                   <div class="col-md-12">
            <div  style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
              <h2 class="accordion-header" id="headingOne">
                <button style="background-color: #020b1c; color: #246bf4" class="accordion-button" type="button">
              <b>Scav Name Scav Weapon Scav Distance</b> <i style="margin-left: 9px; color: #246bf4" class="bi bi-chevron-up"></i>
                </button>
              </h2>
            ...
            <div  style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
              <h2 class="accordion-header" id="headingOne">
                <button style="background-color: #020b1c; color: #246bf4" class="accordion-button" type="button">
              <b>Distance draw</b> <i style="margin-left: 9px; color: #246bf4" class="bi bi-chevron-up"></i>
                </button>
              </h2>
             ...
             <div class="col-md-4">
              <center><b style="font-size: 22px;">Misc</b></center>
       <div class="col-md-12">
            <div  style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
              <h2 class="accordion-header" id="headingOne">
                <button style="background-color: #020b1c; color: #246bf4" class="accordion-button" type="button">
              <b>Teleport loot to you</b> <i style="margin-left: 9px; color: #246bf4" class="bi bi-chevron-up"></i>
                </button>
              </h2>
              <div style="color: #afa6a8; background-color: #020b1c;" class="accordion-body">
Teleports loot to your position
</div>
            </div>
            </div>
            ...
            <div  style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
              <h2 class="accordion-header" id="headingOne">
                <button style="background-color: #020b1c; color: #246bf4" class="accordion-button" type="button">
              <b>Unlimited Stamina</b> <i style="margin-left: 9px; color: #246bf4" class="bi bi-chevron-up"></i>
                </button>
              </h2>
              <div style="color: #afa6a8; background-color: #020b1c;" class="accordion-body">
Infinite stamina
            ...
            <div  style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
              <h2 class="accordion-header" id="headingOne">
                <button style="background-color: #020b1c; color: #246bf4" class="accordion-button" type="button">
              <b>Set Time</b> <i style="margin-left: 9px; color: #246bf4" class="bi bi-chevron-up"></i>
                </button>
              </h2>
              <div style="color: #afa6a8; background-color: #020b1c;" class="accordion-body">
Time setting
            ...
            <div  style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
              <h2 class="accordion-header" id="headingOne">
                <button style="background-color: #020b1c; color: #246bf4" class="accordion-button" type="button">
              <b>Player Field Of View</b> <i style="margin-left: 9px; color: #246bf4" class="bi bi-chevron-up"></i>
                </button>
              </h2>
              <div style="color: #afa6a8; background-color: #020b1c;" class="accordion-body">
Adjust the camera distance from the center
</div>
            </div>
            </div>
            ...
            <div  style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
              <h2 class="accordion-header" id="headingOne">
                <button style="background-color: #020b1c; color: #246bf4" class="accordion-button" type="button">
              <b>Dead Corpse</b> <i style="margin-left: 9px; color: #246bf4" class="bi bi-chevron-up"></i>
                </button>
              </h2>
              <div style="color: #afa6a8; background-color: #020b1c;" class="accordion-body">
Display of player's death
</div>
            </div>
            </div>
            ...
            <div  style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
              <h2 class="accordion-header" id="headingOne">
                <button style="background-color: #020b1c; color: #246bf4" class="accordion-button" type="button">
              <b>Loot in map </b> <i style="margin-left: 9px; color: #246bf4" class="bi bi-chevron-up"></i>
                </button>
              </h2>
              <div style="color: #afa6a8; background-color: #020b1c;" class="accordion-body">
All loot on the map
            ...
            <div  style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
              <h2 class="accordion-header" id="headingOne">
                <button style="background-color: #020b1c; color: #246bf4" class="accordion-button" type="button">
              <b>Container In map</b> <i style="margin-left: 9px; color: #246bf4" class="bi bi-chevron-up"></i>
                </button>
              </h2>
              <div style="color: #afa6a8; background-color: #020b1c;" class="accordion-body">
Containers on the map
            ...
            <div  style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
              <h2 class="accordion-header" id="headingOne">
                <button style="background-color: #020b1c; color: #246bf4" class="accordion-button" type="button">
              <b>Loot expensive</b> <i style="margin-left: 9px; color: #246bf4" class="bi bi-chevron-up"></i>
                </button>
              </h2>
              <div style="color: #afa6a8; background-color: #020b1c;" class="accordion-body">
Most expensive item in the container
</div>
            </div>
            </div>
             <div class="col-md-12">
            <div  style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
              <h2 class="accordion-header" id="headingOne">
                <button style="background-color: #020b1c; color: #246bf4" class="accordion-button" type="button">
              <b>Container Cost</b> <i style="margin-left: 9px; color: #246bf4" class="bi bi-chevron-up"></i>
                </button>
              </h2>
              <div style="color: #afa6a8; background-color: #020b1c;" class="accordion-body">
Cost of the Container
    ...
    <div class="mt-5 colch container col-md-12">
        <h2 style="color: #fff !important;" class="fw-bold text-body-emphasis lh-1 mb-3 chtsb">Cheat subscription<br>plans</h2>
                ...
                ">
                    ...
                    <a style="margin-left: 5px;" href="/my/login" class="nav__link"><a id="btn2" onclick="changePrice('btn2', '30')" class="loginbtn btnbuypage">7 day</a></a>
                    ...
                    <a style="margin-left: 5px;" href="/my/login" class="nav__link"><a id="btn4" onclick="changePrice('btn4', '179')" class="buybtn btnbuypage">Lifetime</a></a>
                  </div>
                  <div style="justify-content: center !important; margin: auto; padding-top: 30px; margin-bottom: 50px;" class="row">
                    <div class="col-md-3 mb-3">
                        <div style="background-color: #020b1c; border-color: #020b1c; border-radius: 22px;" class="card">
                            <div class="card-body">
                                <center><h5>Price</h5>
                                    <h2 id="price"><b style="color: #246bf4; font-weight: 500;"><?=$valic?></b><?=$bd?></h2>
                                    <a style="margin-left: 15px;" href="/my/login" class="nav__link"><a href="/my/buy?id=premium2" id="btnbuy" class="loginbtn">Buy</a></a></center>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-5">
...
<script>
  ...
  function changePrice(btnid, price) {
      if (btnid === 'btn1') {
        ...
        document.getElementById('btnbuy').setAttribute("href", "/my/buy?id=premium1");
      }
      ...
      if (btnid === 'btn2') {
        ...
        document.getElementById('btnbuy').setAttribute("href", "/my/buy?id=premium2");
      }
      ...
      if (btnid === 'btn3') {
        ...
        document.getElementById('btnbuy').setAttribute("href", "/my/buy?id=premium3");
      }
      ...
      if (btnid === 'btn4') {
        ...
        document.getElementById('price').innerHTML = '<b style="color: #246bf4; font-weight: 500;"><?=$valic?></b><?=$lf?>';
        document.getElementById('btnbuy').setAttribute("href", "/my/buy?id=premium4");
      }

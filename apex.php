...
<body style="
background-image: url('/static/img/bckap.png') !important;
    ...
    <div class="col-lg-6">
        <p style="font-size: 17px;"><b style="color: #86FF0D; font-weight: 400; margin-left: 20px;">
            ...
            <circle cx="5" cy="5" r="5" fill="#86FF0D"/> Undetected
             ...
             Undetected</b></p>
      <h1 style="color: #fff !important; font-size: 75px;" class="fw-bold text-body-emphasis lh-1 mb-3"><img style="margin-right: 10px;" width="60" src="/static/img/apic.png">Apex</h1>
      <p style="font-size: 20px; color: #aca6a7; margin-top: 20px; margin-bottom: 20px;">Welcome to Aworex – Your Apex Legends Game-Changer!<br><br>

Aworex is the ultimate cheat designed to revolutionize your Apex Legends gaming experience. Dive into the world of Apex with confidence, knowing that Aworex offers unparalleled enhancements. Our cutting-edge features are fortified by robust security measures, ensuring you game with peace of mind. Join our community and discover Apex Legends in a whole new light with Aworex.</p>
    ...
    <div class="col-10 col-sm-8 col-lg-6">
        <video style="width: 100% !important; margin-top: 30px;" src="/static/apex.mp4" class="d-block imgFullItem" controls="" autoplay="" muted=""></video>
    </div>
  </div>
  </div>
  ...
  <div class="container col-xxl-8">
    ...
    <div class="mt-5 colch container col-md-12">
        <h1 style="color: #fff !important;" class="fw-bold text-body-emphasis lh-1 mb-3 chtsb">Cheat subscription<br>plans</h1>
                ...
                ">
                    <a href="/my/login" class="nav__link"><a id="btn1" onclick="changePrice('btn1', '5')" class="buybtn btnbuypage">1 days</a></a>
                    <a style="margin-left: 5px;" href="/my/login" class="nav__link"><a id="btn2" onclick="changePrice('btn2', '30')" class="loginbtn btnbuypage">3 days</a></a>
                    <a style="margin-left: 5px;" href="/my/login" class="nav__link"><a id="btn3" onclick="changePrice('btn3', '30')" class="buybtn btnbuypage">7 days</a></a>
                    <a style="margin-left: 5px;" href="/my/login" class="nav__link"><a id="btn4" onclick="changePrice('btn4', '30')" class="buybtn btnbuypage">30 days</a></a>
                  </div>
...
<script>
  ...
  function changePrice(btnid, price) {
      if (btnid === 'btn1') {
        ...
        document.getElementById('btnbuy').setAttribute("href", "/my/buy?id=ap1");
      }
      ...
      if (btnid === 'btn2') {
        ...
        document.getElementById('btnbuy').setAttribute("href", "/my/buy?id=ap2");
      }
      ...
      if (btnid === 'btn3') {
        ...
        document.getElementById('btnbuy').setAttribute("href", "/my/buy?id=ap3");
      }
      ...
      if (btnid === 'btn4') {
        ...
        document.getElementById('price').innerHTML = '<b style="color: #246bf4; font-weight: 500;">$</b>50';
        document.getElementById('btnbuy').setAttribute("href", "/my/buy?id=ap4");
      }

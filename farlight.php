...
?>
  ...
  <div class="row align-items-center g-5 py-5">
    ...
    <div class="col-lg-6">
    <?php
    if ((int)$data_tvt['farlight'] === 1) {
        $text = 'Undetected';
        $color = '#86FF0D'; 
    } else if ((int)$data_tvt['farlight'] === 2) {
        $text = 'Updating';
        $color = '#f4900c'; 
    } else {
        $text = 'Detected';
    ...
    ?>
        <p style="font-size: 17px;"><b style="color: <?=$color?>; font-weight: 400; margin-left: 20px;">
            ...
            <circle cx="5" cy="5" r="5" fill="<?=$color?>"/> <?=$text?>
             ...
             <?=$text?></b></p>
      <h1 style="color: #fff !important; font-size: 75px;" class="fw-bold text-body-emphasis lh-1 mb-3"><img style="margin-right: 10px;" width="60" src="/static/img/flic.png">Farlight</h1>
...
<div class="col-lg-4">
          <div class="row">
           <center> <h4><b>CONFIGS</b></h4></center>
            ...
            <div  style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
              ...
              <div style="background-color: #020b1c;" id="collapseOne" class="accordion-collapse  show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                <div style="color: #afa6a8; margin-top: -20px;" class="accordion-body">
                   allows you to use the loader, and any functions without a screen recorder, or application to capture screen images see the activated functions, for example, do live without people seeing the ESP activated...
                </div>
              </div>
            </div>
            <div  style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
                ...
                <div style="background-color: #020b1c;" id="collapseOnet" class="accordion-collapse  show" aria-labelledby="headingOnet" data-bs-parent="#accordionExample">
                  <div style="color: #afa6a8; margin-top: -20px;" class="accordion-body">
                      shortcut key to hide and make it appear again on your screen
                  </div>
                </div>
              </div>
              <div  style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
              ...
              <div  style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
                ...
                <div style="background-color: #020b1c;" id="collapseOnett" class="accordion-collapse  show" aria-labelledby="headingOnett" data-bs-parent="#accordionExample">
                  <div style="color: #afa6a8; margin-top: -20px;" class="accordion-body">
                     shortcut key to forcibly close the menu
                  </div>
                </div>
              </div>
      ...
      <center><h4><b>ESP</b></h4></center>
        <div class="accordion" id="accordionExample">
            ...
            <div style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
                ...
                <div style="background-color: #020b1c;" id="collapseOnet" class="accordion-collapse  show" aria-labelledby="headingOnet" data-bs-parent="#accordionExample">
                  <div style="color: #afa6a8; margin-top: -20px;" class="accordion-body">
                      will show the name of the map participants
                  </div>
                </div>
              </div>
              ...
              <div style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
                ...
                <div style="background-color: #020b1c;" id="collapseOnettt" class="accordion-collapse  show" aria-labelledby="headingOnettt" data-bs-parent="#accordionExample">
                  <div style="color: #afa6a8; margin-top: -20px;" class="accordion-body">
                      will show the HP of opponents on the map
                  </div>
                </div>
              </div>
              ...
              <div style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
                ...
                <div style="background-color: #020b1c;" id="collapseOnettt" class="accordion-collapse  show" aria-labelledby="headingOnettt" data-bs-parent="#accordionExample">
                  <div style="color: #afa6a8; margin-top: -20px;" class="accordion-body">
                       will draw a circle around the head of the characters/their opponents, which can be changed to a large and small circle
                  </div>
                </div>
              </div>
      ...
      <center><h4><b>AIM</b></h4></center>
        <div class="accordion" id="accordionExample">
            <div  style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
              ...
              <div style="background-color: #020b1c;" id="collapseOne" class="accordion-collapse  show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                <div style="color: #afa6a8; margin-top: -20px;" class="accordion-body">
                    Enable: will activate the AIMBOT function
                </div>
              </div>
            </div>
            <div  style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
                ...
                <div style="background-color: #020b1c;" id="collapseOnet" class="accordion-collapse  show" aria-labelledby="headingOnet" data-bs-parent="#accordionExample">
                  <div style="color: #afa6a8; margin-top: -20px;" class="accordion-body">
                      First Bar: represents the Fov circle in the center of your screen, if it is bigger, the detection field for the aimbot to work will be bigger too, or smaller, the field will be smaller and it will have more legit.
                  </div>
                </div>
              </div>
              <div  style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
                ...
                <div style="background-color: #020b1c;" id="collapseOnett" class="accordion-collapse  show" aria-labelledby="headingOnett" data-bs-parent="#accordionExample">
                  <div style="color: #afa6a8; margin-top: -20px;" class="accordion-body">
                      represents the Smoth, which has the role of changing the speed at which your mouse will move towards your opponent, therefore, the lower its value, the faster your mouse will move towards your opponent, and the greater his number, the more legit it will be.
                  </div>
                </div>
              </div>
              <div  style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
                ...
                <div style="background-color: #020b1c;" id="collapseOnettt" class="accordion-collapse  show" aria-labelledby="headingOnettt" data-bs-parent="#accordionExample">
                  <div style="color: #afa6a8; margin-top: -20px;" class="accordion-body">
                      key that will be used to activate the aimbot, for example, when spotting an enemy, to be able to use the aimbot, press the pre-configured key in the "Aim Key" field...
                  </div>
                </div>
              </div>

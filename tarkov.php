    ...
    ?>
        <p style="font-size: 17px;"><b style="color: <?=$color?>; font-weight: 400; margin-left: 20px;">
            ...
            <circle cx="5" cy="5" r="5" fill="<?=$color?>"/> <?=$text?>
             ...
             <?=$text?></b></p>
      <h1 style="color: #fff !important; font-size: 75px;" class="fw-bold text-body-emphasis lh-1 mb-3"><img style="margin-right: 10px;" width="60" src="/static/img/eft.png">Escape From Tarkov</h1>
...
The premier Escape from Tarkov cheat. Immerse yourself in the game's world with confidence, knowing that our undetected hack brings unparalleled safety. Our features are backed by robust security measures, ensuring you that you won't get banned. Buy Cheats for Tarkov and join our community and explore Tarkov like never before with Aworex.</p>
  ...
  <div class="container col-xxl-8">
    <h2 style="color: #fff !important; font-size: 75px;" class="fw-bold text-body-emphasis lh-1 mb-3">Functions</h2>
  </div>
  <div class="container col-xxl-8">
      ...
      <div class="col-10 col-sm-8 col-lg-6">
          <div class="row">
            ...
            <div class="col-6 mb-3">
              <a href="#" data-fancybox="responsive" class="colorbox" data-src="/index_files/pmc1.png"><img src="/index_files/pmc1.png" alt=""></a>
            </div>
            <div class="col-6 mb-3">
              <a href="#" data-fancybox="responsive" class="colorbox" data-src="/index_files/pmc2.png"><img src="/index_files/pmc2.png" alt=""></a>
            </div><br>
            <h6>SCAV</h6>
            <div class="col-6 mb-3">
              <a href="#" data-fancybox="responsive" class="colorbox" data-src="/index_files/scav1.png"><img src="/index_files/scav1.png" alt=""></a>
            </div>
            <div class="col-6 mb-3">
              <a href="#" data-fancybox="responsive" class="colorbox" data-src="/index_files/scav2.png"><img src="/index_files/scav2.png" alt=""></a>
            </div>
            <h6>ITEMS</h6>
            <div class="col-6 mb-3">
              <a href="#" data-fancybox="responsive" class="colorbox" data-src="/index_files/items1.png"><img src="/index_files/items1.png" alt=""></a>
            </div>
            <div class="col-6 mb-3">
              <a href="#" data-fancybox="responsive" class="colorbox" data-src="/index_files/items2.png"><img src="/index_files/items2.png" alt=""></a>
            </div>
            <h6>BOSS</h6>
            <div class="col-6 mb-3">
              <a href="#" data-fancybox="responsive" class="colorbox" data-src="/index_files/boss1.png"><img src="/index_files/boss1.png" alt=""></a>
            </div>
            <div class="col-6 mb-3">
              <a href="#" data-fancybox="responsive" class="colorbox" data-src="/index_files/boss2.png"><img src="/index_files/boss2.png" alt=""></a>
            </div>
          </div>
      </div>
      <div class="col-lg-6 container">
        <div class="accordion" id="accordionExample" style="border-radius: 15px; ">
            <div  style="border-color: #020b1c; margin-bottom: 15px; " class="accordion-item">
              <h2 class="accordion-header" id="headingOne">
                <button style="background-color: #020b1c; color: #246bf4" class="accordion-button" type="button">
              <b>ESP (Opponents)</b> <i style="margin-left: 9px; color: #246bf4" class="bi bi-chevron-up"></i>
                </button>
              </h2>
              <div style="background-color: #020b1c;" id="collapseOne" class="accordion-collapse  show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                <div style="color: #afa6a8;" class="accordion-body">
                    You are able to easily see your opponents through any<br> walls/surfaces which will help you to eliminate your opponents<br> and successfully complete a raid.
                </div>
              </div>
            </div>
            <div  style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
                ...
                <b>ESP (Items)</b> <i style="margin-left: 9px; color: #246bf4" class="bi bi-chevron-up"></i>
                  </div>
                </h2>
                <div style="background-color: #020b1c;" id="collapseOnet" class="accordion-collapse  show" aria-labelledby="headingOnet" data-bs-parent="#accordionExample">
                  <div style="color: #afa6a8;" class="accordion-body">
                      Items are easily identifiable and visible through closed rooms within a radius of 15-20 meters, and a radius of 100-150 meters in open areas!
                  </div>
                </div>
              </div>
              <div  style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
                ...
                <b>NoRecoil</b> <i style="margin-left: 9px; color: #246bf4" class="bi bi-chevron-up"></i>
                  </div>
                </h2>
                <div style="background-color: #020b1c;" id="collapseOnett" class="accordion-collapse  show" aria-labelledby="headingOnett" data-bs-parent="#accordionExample">
                  <div style="color: #afa6a8;" class="accordion-body">
                      NoRecoil - disabling the recoil of any weapons.<br> Thanks to this feature, you will always win.
                  </div>
                </div>
              </div>
              <div  style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
                <h2 class="accordion-header" id="headingOnettt">
                  <div style="background-color: #020b1c; color: #246bf4" class="accordion-button" type="button">
                <b>Big heads</b> <i style="margin-left: 9px; color: #246bf4" class="bi bi-chevron-up"></i>
                  </div>
                </h2>
              ...
              <div  style="border-color: #020b1c; margin-bottom: 15px; border-radius: 15px;" class="accordion-item">
                <h2 class="accordion-header" id="headingOnettt">
                  <div style="background-color: #020b1c; color: #246bf4" class="accordion-button" type="button">
                <b>LagSwitch</b> <i style="margin-left: 9px; color: #246bf4" class="bi bi-chevron-up"></i>
                  </div>
                </h2>
                <div style="background-color: #020b1c;" id="collapseOnettt" class="accordion-collapse  show" aria-labelledby="headingOnettt" data-bs-parent="#accordionExample">
                  <div style="color: #afa6a8;" class="accordion-body">
                      All enemies freeze for a few seconds
                  </div>
                </div>
              </div>
...
<script>
  ...
  function changePrice(btnid, price) {
      if (btnid === 'btn1') {
        ...
        document.getElementById('btnbuy').setAttribute("href", "/my/buy?id=cheat1");
      }
      ...
      if (btnid === 'btn2') {
        ...
        document.getElementById('btnbuy').setAttribute("href", "/my/buy?id=cheat3");
      }
      ...
      if (btnid === 'btn3') {
        ...
        document.getElementById('btnbuy').setAttribute("href", "/my/buy?id=cheat5");
      }
      ...
      if (btnid === 'btn4') {
        ...
        document.getElementById('btnbuy').setAttribute("href", "/my/buy?id=cheat6");
      }
